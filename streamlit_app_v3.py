...
def load_data():
    with st.spinner(text="Loading and indexing the QUADS and Badfish docs – hang tight! This should take 1-2 minutes."):
        ...
        template = """Use the following pieces of retrieved context to answer the question. If you don't know the answer, just say that you don't know. Keep the answer concise. Give full command examples if possible. Do not hallucinate new features. Give more importance to the context rather than the chat history.
